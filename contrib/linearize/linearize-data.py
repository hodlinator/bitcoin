...
#
# Takes list of block hashes generated by linearize-hashes.py and reads block
# files from the local datadir which may contain out of order blocks. Writes out
# the same blocks but now in the order of the aforementioned list. Also removes
# XORing of block data.
#
