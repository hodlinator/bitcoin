...
private:
    ...
    UAmount m_total_subsidy{0_sats};
    ...
    UAmount m_total_unspendables_genesis_block{0_sats};
    UAmount m_total_unspendables_bip30{0_sats};
    UAmount m_total_unspendables_scripts{0_sats};
