...
private:
    ...
    BlockValidationState FindUndoPos(int nFile, FlatFilePos& pos, unsigned int nAddSize);
...
public:
    ...
    BlockValidationState WriteBlockUndo(const CBlockUndo& blockundo, CBlockIndex& block)
        EXCLUSIVE_LOCKS_REQUIRED(::cs_main);
