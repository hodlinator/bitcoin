...
constexpr Amount DEFAULT_BLOCK_MIN_TX_FEE{1_sats};
...
constexpr Amount DEFAULT_INCREMENTAL_RELAY_FEE{100_sats};
...
constexpr Amount DUST_RELAY_TX_FEE{3000_sats};
/** Default for -minrelaytxfee, minimum relay fee for transactions */
constexpr Amount DEFAULT_MIN_RELAY_TX_FEE{100_sats};
