...
constexpr UAmountLiteral DEFAULT_BLOCK_MIN_TX_FEE{1_sats};
...
constexpr UAmountLiteral DEFAULT_INCREMENTAL_RELAY_FEE{100_sats};
...
constexpr UAmountLiteral DUST_RELAY_TX_FEE{3000_sats};
/** Default for -minrelaytxfee, minimum relay fee for transactions */
constexpr UAmountLiteral DEFAULT_MIN_RELAY_TX_FEE{100_sats};
...
UAmount GetDustThreshold(const CTxOut& txout, const CFeeRate& dustRelayFee);
