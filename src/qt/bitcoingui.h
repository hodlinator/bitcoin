...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, BitcoinUnit unit, const Amount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
