...
//! Construct a miniscript node (will be removed in next commit).
...
public:
    ...
    const std::vector<Node>& GetSubs() const { return subs; }
...
private:
    ...
    // Only used by Clone()
    Node(internal::NoDupCheck, MiniscriptContext script_ctx, Fragment nt, std::vector<Node> sub, std::vector<Key> key, std::vector<unsigned char> arg, uint32_t val)
...
public:
    ...
    Node(internal::NoDupCheck, MiniscriptContext script_ctx, Fragment nt, std::vector<Node> sub, std::vector<unsigned char> arg, uint32_t val = 0)
    ...
    Node(internal::NoDupCheck, MiniscriptContext script_ctx, Fragment nt, std::vector<Node> sub, std::vector<Key> key, uint32_t val = 0)
    ...
    Node(internal::NoDupCheck, MiniscriptContext script_ctx, Fragment nt, std::vector<Node> sub, uint32_t val = 0)
    ...
    template <typename Ctx> Node(const Ctx& ctx, Fragment nt, std::vector<Node> sub, std::vector<unsigned char> arg, uint32_t val = 0)
    ...
    template <typename Ctx> Node(const Ctx& ctx, Fragment nt, std::vector<Node> sub, std::vector<Key> key, uint32_t val = 0)
    ...
    template <typename Ctx> Node(const Ctx& ctx, Fragment nt, std::vector<Node> sub, uint32_t val = 0)
