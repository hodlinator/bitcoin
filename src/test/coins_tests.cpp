...
static void CheckAddCoinBase(CAmount base_value, const CoinEntry& cache_coin, CAmount modify_value, const CoinEntry& expected, bool coinbase)
{
    SingleEntryCacheTest test{base_value, cache_coin};
    try {
        CTxOut output;
...
{
    CheckAddCoinBase(base_value, CoinEntry{cache_value, cache_flags}, modify_value, CoinEntry{expected_value, expected_flags}, coinbase);
}
