...
{
    {
        ...
        std::span<const std::byte> input{StringToBytes("once upon a time\n there was a dog \r\nwho liked food\n")};
    ...
    }
    {
        ...
        std::span<const std::byte> input{StringToBytes("once upon a time there\nwas a dog who liked tea\n")};
    ...
    }
    {
        ...
        std::span<const std::byte> input{StringToBytes("\n")};
    ...
    }
    {
        ...
        std::span<const std::byte> input{StringToBytes("ab\n")};
    ...
    {
        std::span<const std::byte> input{StringToBytes("a\nb\n")};
        LineReader reader(input, /*max_line_length=*/1);
