...
{
    BOOST_CHECK_EQUAL(ParseFixedPoint("0", 8), 0LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1", 8), 100000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("0.0", 8), 0LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("-0.1", 8), -10000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1.1", 8), 110000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1.10000000000000000", 8), 110000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1.1e1", 8), 1100000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1.1e-1", 8), 11000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1000", 8), 100000000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("-1000", 8), -100000000000LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("0.00000001", 8), 1LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("0.0000000100000000", 8), 1LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("-0.00000001", 8), -1LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("1000000000.00000001", 8), 100000000000000001LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("9999999999.99999999", 8), 999999999999999999LL);
    BOOST_CHECK_EQUAL(ParseFixedPoint("-9999999999.99999999", 8), -999999999999999999LL);

    BOOST_CHECK(!ParseFixedPoint("", 8));
    BOOST_CHECK(!ParseFixedPoint("-", 8));
    BOOST_CHECK(!ParseFixedPoint("a-1000", 8));
    BOOST_CHECK(!ParseFixedPoint("-a1000", 8));
    BOOST_CHECK(!ParseFixedPoint("-1000a", 8));
    BOOST_CHECK(!ParseFixedPoint("-01000", 8));
    BOOST_CHECK(!ParseFixedPoint("00.1", 8));
    BOOST_CHECK(!ParseFixedPoint(".1", 8));
    BOOST_CHECK(!ParseFixedPoint("--0.1", 8));
    BOOST_CHECK(!ParseFixedPoint("0.000000001", 8));
    BOOST_CHECK(!ParseFixedPoint("-0.000000001", 8));
    BOOST_CHECK(!ParseFixedPoint("0.00000001000000001", 8));
    BOOST_CHECK(!ParseFixedPoint("-10000000000.00000000", 8));
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000000", 8));
    BOOST_CHECK(!ParseFixedPoint("-10000000000.00000001", 8));
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000001", 8));
    BOOST_CHECK(!ParseFixedPoint("-10000000000.00000009", 8));
    BOOST_CHECK(!ParseFixedPoint("10000000000.00000009", 8));
    BOOST_CHECK(!ParseFixedPoint("-99999999999.99999999", 8));
    BOOST_CHECK(!ParseFixedPoint("99999909999.09999999", 8));
    BOOST_CHECK(!ParseFixedPoint("92233720368.54775807", 8));
    BOOST_CHECK(!ParseFixedPoint("92233720368.54775808", 8));
    BOOST_CHECK(!ParseFixedPoint("-92233720368.54775808", 8));
    BOOST_CHECK(!ParseFixedPoint("-92233720368.54775809", 8));
    BOOST_CHECK(!ParseFixedPoint("1.1e", 8));
    BOOST_CHECK(!ParseFixedPoint("1.1e-", 8));
    BOOST_CHECK(!ParseFixedPoint("1.", 8));

    // Test with 3 decimal places for fee rates in sat/vB.
    BOOST_CHECK_EQUAL(ParseFixedPoint("0.001", 3), CAmount{1});
    BOOST_CHECK(!ParseFixedPoint("0.0009", 3));
    BOOST_CHECK(!ParseFixedPoint("31.00100001", 3));
    BOOST_CHECK(!ParseFixedPoint("31.0011", 3));
    BOOST_CHECK(!ParseFixedPoint("31.99999999", 3));
    BOOST_CHECK(!ParseFixedPoint("31.999999999999999999999", 3));
}
