...
public:
    ...
    virtual void SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, CAmountUnchecked fee) noexcept = 0;
...
public:
    ...
    void SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, CAmountUnchecked fee) noexcept final;
...
public:
    ...
    *   transactions from inherited (P,M) to explicit (P,P). */
    ...
    void SetTransactionFee(const Ref&, CAmountUnchecked fee) noexcept final;
...
void GenericClusterImpl::SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, CAmountUnchecked fee) noexcept
{
...
void SingletonClusterImpl::SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, CAmountUnchecked fee) noexcept
{
    Assume(GetTxCount());
    Assume(idx == 0);
    m_feerate.fee = fee;
...
void TxGraphImpl::SetTransactionFee(const Ref& ref, CAmountUnchecked fee) noexcept
{
