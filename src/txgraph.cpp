...
public:
    ...
    virtual void SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, Amount fee) noexcept = 0;
...
public:
    ...
    void SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, Amount fee) noexcept final;
...
public:
    ...
    *   transactions from inherited (P,M) to explicit (P,P). */
    ...
    void SetTransactionFee(const Ref&, Amount fee) noexcept final;
...
void GenericClusterImpl::SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, Amount fee) noexcept
{
...
void SingletonClusterImpl::SetFee(TxGraphImpl& graph, int level, DepGraphIndex idx, Amount fee) noexcept
{
    Assume(GetTxCount());
    Assume(idx == 0);
    m_feerate.fee = fee;
...
void TxGraphImpl::SetTransactionFee(const Ref& ref, Amount fee) noexcept
{
