...
protected:
    [[nodiscard]] util::Expected<void, kernel::FatalError> ActivateBestChainStep(
        CBlockIndex& index_most_work,
        const std::shared_ptr<const CBlock>& pblock,
        bool& fInvalidFound,
        std::vector<ConnectedBlock>& connected_blocks) EXCLUSIVE_LOCKS_REQUIRED(cs_main, m_mempool->cs);
...
public:
    ...
    * even though that may not actually be the case. */
     ...
     */
    util::Expected<bool, kernel::FatalError> ProcessNewBlock(
