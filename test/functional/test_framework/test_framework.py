...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def parse_args(self, test_file):
        ...
        parser.add_argument("--debug_cmd", dest="debug_cmd",
                            #default="subl --wait --command \"debugger {\\\"action\\\": \\\"start\\\", \\\"configuration\\\": {\\\"name\\\": \\\"test_framework_node\\\", \\\"type\\\": \\\"lldb\\\", \\\"request\\\": \\\"launch\\\", \\\"stopOnEntry\\\": false, \\\"program\\\": \\\"$EXECUTABLE$\\\", \\\"args\\\": $ARGS_REPR$}}\"",
                            default="kgx -- /nix/store/3iwjzxizm6jbhl2p7ksciwcryhs1kdcy-lldb-19.1.7/bin/lldb -o run -- $EXECUTABLE$ $ARGS_ARRAY$",
                            help="Debugger command to launch nodes with (can be specified using debug_runs).")
        parser.add_argument("--debug_runs", dest="debug_runs", nargs="*", type=int, default=[],
                            help="Node executions in the test to run under the debugger (debug_cmd), 0-based.")
